	            ...
	            Padding(
	              ...
	              child: Column(
	                children: <Widget>[
	                  ...
	                  FadeAnimation(2, Container(
                        ...
                        child: FlatButton(
                          ...
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => MenuPage(prof)),);
                    ...
                    SizedBox(height: 20,),
	                  ...
	                  SizedBox(height: 50,),
	                  FadeAnimation(1.5, Text("Forgot Password?", style: TextStyle(color: Color.fromRGBO(0, 0, 0, 1)),)),
	                ],
	              ),
	            )
	          ],
